...
/**
 * Write a description of class Wolverine here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Wolverine extends Monster
{
    int leben = 2;
    public Wolverine(){
        super();
    ...
    /**
     * Act - do whatever the Wolverine wants to do. This method is called whenever
